...
<table border="1" cellpadding="0" cellspacing="0" width="100%">
    ...
    <?php
        ...
        $sql_tong_ban_ghi = "SELECT COUNT(size_id)
                AS tong_so_ban_ghi
                FROM size
                WHERE size.size_name LIKE '%$search%'";
    ...
    ?>
            <tr>
                <td><?php echo $each['size_id'];?></td>
                <td><?php echo $each['size_name'];?></td>
                <td>
                    <a href="update.php?size_id=<?php echo $each['size_id'];?>"><i class="fas fa-edit" style="color:blue;"></i></a>
                </td>
                <td>
                    <a href="delete.php?size_id=<?php echo $each['size_id'];?>"><i class="material-icons" style="color:blue;" >&#xe872;</i></a>
                </td>
            </tr>
    <?php
        }
